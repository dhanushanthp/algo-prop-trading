...
class SniperReloaded():
    ...
    def main(self):
        ...
        while True:
            ...
            print(f"\n------- {self.trading_timeframe} TF {self.strategy.upper()}, Adddtional: {self.addtional_levels}, Trace Exit:{self.trace_exit}, Early Profit:{self.early_profit} ({self.early_rr} RR) -----------")
