...
def get_dollar_value(symbol):
        ...
        if curr.company == "FTMO S.R.O.":
            ...
            if symbol == "SP_raw":
                ...
                return round(1/get_exchange_price("USDHKD_raw"), 4)
...
def adjust_positions_trailing_stops():
    ...
    for position in existing_positions:
        ...
        tgt_candle_high, tgt_candle_low, _, _, _ = ind.get_stop_range(symbol=symbol, timeframe=tgt_tf, n_spreds=3, multiplier=1.1)
